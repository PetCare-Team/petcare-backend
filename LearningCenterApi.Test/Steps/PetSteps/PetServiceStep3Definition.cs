...
[Binding]
public sealed class PetServiceStep3Definition : WebApplicationFactory<Program>
{
    ...
    public PetServiceStep3Definition(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
...
available")]
    ...
    public void WhenADeleteRequestIsSent(Table savePetResource)
    {
        var resource =
